  ...
  return (
    <>
      <div className="flex items-center gap-2">
        ...
        <DeleteButton id={company.id} entityType="companies" entityName={company.title} redirectTo="/companies" />
      </div>
      <Modal isOpen={showEdit} onClose={() => setShowEdit(false)} title="Edit Company">
