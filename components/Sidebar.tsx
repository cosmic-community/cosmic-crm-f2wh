...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Header Bar */}
      <div className="fixed top-0 left-0 right-0 h-16 bg-slate-900 text-white flex items-center justify-between px-4 z-50 lg:hidden">
        <Link href="/" className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold tracking-tight">Cosmic CRM</h1>
        </Link>
        <button
      ...
      <aside className={`fixed left-0 top-0 h-screen w-64 bg-slate-900 text-white flex flex-col z-50 transition-transform duration-300 ease-in-out ${
        ...
        <div className="px-6 py-6 border-b border-white/10">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight">Cosmic CRM</h1>
              <p className="text-xs text-gray-400">Sales Pipeline</p>
            </div>
          </Link>
        </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">CRM Admin</p>
